						...
						<div class="x_content">
							<form action="<?=base_url($target_url)?>" method="post" enctype="multipart/form-data">
								...
								<div class=" field item form-group">
									...
									<div class="input-group col-md-6 col-sm-6">
										<select class="form-control <?=(!empty(session()->getFlashdata('validation')['publisher'])) ? 'is-invalid' : ''?>" name="id_publisher">
											<option value=""></option>
										...
										<div class="invalid-feedback">
											<?=(!empty(session()->getFlashdata('validation')['publisher'])) ? session()->getFlashdata('validation')['publisher'] : ''?>
										</div>
									</div>
								</div>
								<div class=" field item form-group">
									...
									<div class="input-group col-md-6 col-sm-6">
										<select class="form-control <?=(!empty(session()->getFlashdata('validation')['category'])) ? 'is-invalid' : ''?>" name="id_category">
											<option value=""></option>
								...
								<div class=" field item form-group">
									...
									<div class="input-group col-md-6 col-sm-6">
										<input type="text" name="quantity" class="form-control <?=(!empty(session()->getFlashdata('validation')['quantity'])) ? 'is-invalid' : ''?>" placeholder="" value="<?= ($is_edit) ? $item['quantity'] : old('quantity') ?>">
										<div class="invalid-feedback">
