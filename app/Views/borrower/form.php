						...
						<div class="x_content">
							<form action="<?=base_url($target_url)?>" method="post" enctype="multipart/form-data">
								...
								<div class=" field item form-group">
									...
									<div class="input-group col-md-6 col-sm-6">
										<input type="text" name="address" class="form-control <?=(!empty(session()->getFlashdata('validation')['address'])) ? 'is-invalid' : ''?>" placeholder="" value="<?= ($is_edit) ? $item['address'] : old('birthdate') ?>">
										<div class="invalid-feedback">
